# Contributing to StellarAgentKit

Thank you for your interest in contributing to StellarAgentKit — Secure AI Agent Infrastructure for Autonomous Finance on Stellar. This guide covers everything you need to get started.
...
StellarAgentKit participates in the **Stellar Drips Wave** program. Funded issues are tagged with the `Stellar Wave` label on GitHub and detailed in the project's issue list.
...
### Tech Stack Context:
* **Core Technologies:** TypeScript/LangChain for SDK, Soroban/Rust for contracts, React/Vite for playground

### Setup Commands:
```bash
# Clone the repository
git clone https://github.com/stellaragentkit-phantom/stellaragentkit-sdk
cd stellaragentkit-sdk
...
Thank you for contributing to StellarAgentKit! 🚀
